...
<div class="row-fluid">
	...
	<div class="span10">
	<div class="hero-unit">
			<s:form action="courses-modify" onSubmit="submits();">
			<s:hidden name="course.id" />
				<s:hidden name="course.createTime" />
				<s:hidden name="course.type" />
					<table class="table">
						<tbody>
						<s:textfield name="course.title" label="%{getText('news.title')}"/>
						<tr>
							<td colspan="2">
								<s:textarea id="ckeditor" cssClass="ckeditor" name="course.content"/>
							</td>
						</tr>
						<tr><td colspan="2">
