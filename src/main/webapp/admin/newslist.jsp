...
<div class="row-fluid">
	...
	<div class="hero-unit">
		...
		<s:sort comparator="newsIDComparator" source="news">
		<s:iterator>
		<tr>
		...
		<td>
			<a class="btn btn-info" href="<%=basePath%>admin/editnews.action?newsID=<s:property value="id"/>">
			<i class="icon-edit icon-white"></i>&nbsp;<s:text name="news.button.edit" />
			</a>
		</td>
		<td>
			<a class="btn btn-danger" href="<%=basePath%>admin/deletenews.action?newsID=<s:property value="id"/>" 
		...
		<tr>
		<td colspan="6">
			<a class="btn" href="<%=basePath%>admin/createnews.jsp">
