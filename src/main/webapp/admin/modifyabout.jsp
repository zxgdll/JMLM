...
<div class="row-fluid">
	...
	<div class="well sidebar-nav">
		...
		<li class="active"><a href="#"><s:text name="home.about" /></a></li>
	...
	<div class="span10">
	<div class="hero-unit">
		<s:form action="update_about" theme="simple">
			<s:hidden name="about.id" />
			<s:hidden name="about.createTime" />
			<s:hidden name="about.type" />
			<s:hidden name="about.title" />
			<table class="table">
			<tr>
			<td>
			<s:textarea id="ckeditor" cssClass="ckeditor" name="about.content"/>
			</td>
			</tr>
			<tr>
			<td>
